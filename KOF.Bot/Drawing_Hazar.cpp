...
{
    ImGui::BeginChild(skCryptDec("MainController"), ImVec2(282, 118), true);
    {
        ...
        ImGui::Spacing();
        {
            ...
            if (ImGui::Button(bAttackStatus ? skCryptDec("Saldiri Durdur") : skCryptDec("Saldiri Baslat"), ImVec2(129.0f, 0.0f)))
            {
            ...
            if (ImGui::Button(bCharacterStatus ? skCryptDec("Bot Durdur") : skCryptDec("Bot Baslat"), ImVec2(129.0f, 0.0f)))
            {
            ...
            if (ImGui::Button(skCryptDec("Town At"), ImVec2(129.0f, 0.0f)))
            {
            ...
            if (ImGui::Button(skCryptDec("Skilleri Yenile"), ImVec2(129.0f, 0.0f)))
            {
            ...
            if (ImGui::Button(skCryptDec("Ayarlari Sifirla"), ImVec2(266.0f, 0.0f)))
            {
...
{
    ImGui::BeginChild(skCryptDec("TransformationController"), ImVec2(282, 92), true);
    {
...
{
    ImGui::BeginChild(skCryptDec("SpeedController"), ImVec2(282, 120), true);
    {
...
{
    ImGui::BeginChild(skCryptDec("DistanceController"), ImVec2(282, 92), true);
    {
...
{
    ImGui::BeginChild(skCryptDec("ProtectionController"), ImVec2(282, 118), true);
    {
...
{
    ImGui::BeginChild(skCryptDec("AutoLootController"), ImVec2(282, 118), true);
    {
        ...
        ImGui::Spacing();
        {
            ...
            ImGui::Text(skCryptDec("Kutuyu Acmadan Bekle (ms)"));
            ...
            if (ImGui::DragInt(skCryptDec("##WaitWhileOpenLoot"), &iWaitWhileOpenTime, 1, 0, INT_MAX))
...
{
    ImGui::BeginChild(skCryptDec("AttackController"), ImVec2(282, 92), true);
    {
...
{
    ImGui::BeginChild(skCryptDec("IllegalController"), ImVec2(282, 144), true);
    {
...
{
    ImGui::BeginChild(skCryptDec("SizeController"), ImVec2(282, 92), true);
    {
...
{
    ImGui::BeginChild(skCryptDec("SaveCPUController"), ImVec2(282, 70), true);
    {
...
{
    ImGui::BeginChild(skCryptDec("SupplyController"), ImVec2(282, 70), true);
    {
...
{
    ImGui::BeginChild(skCryptDec("ListenerController"), ImVec2(282, 93), true);
    {
...
{
    ImGui::BeginChild(skCryptDec("PartyController"), ImVec2(282, 70), true);
    {
...
{
    ImGui::BeginChild(skCryptDec("SettingsController"), ImVec2(282, 120), true);
    {
