...
#define GH_INJ_MOD_NAME64W L"Injector-x64.dll"
#define GH_INJ_MOD_NAME86W L"Injector-x86.dll"

#define GH_INJ_MOD_NAME64A "Injector-x64.dll"
#define GH_INJ_MOD_NAME86A "Injector-x86.dll"
...
#define MM_DEFAULT (INJ_THREAD_CREATE_CLOAKED | INJ_UNLINK_FROM_PEB | INJ_ERASE_HEADER | INJ_MM_RESOLVE_IMPORTS | INJ_MM_RESOLVE_DELAY_IMPORTS | INJ_MM_INIT_SECURITY_COOKIE | INJ_MM_EXECUTE_TLS | INJ_MM_ENABLE_EXCEPTIONS | INJ_MM_RUN_DLL_MAIN | INJ_MM_SET_PAGE_PROTECTIONS)
